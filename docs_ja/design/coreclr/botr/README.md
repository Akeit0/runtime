...
- [Garbage Collection の設計](../../../../docs/design/coreclr/botr/garbage-collection.md)
...
- [Method Descriptor](../../../../docs/design/coreclr/botr/method-descriptor.md)
- [Virtual Stub Dispatch](virtual-stub-dispatch.md)
- [Stack Walking](stackwalking.md)
- [`System.Private.CoreLib` とランタイム呼び出し](../../../../docs/design/coreclr/botr/corelib.md)
